...
if __name__ == "__main__":
    ...
    # convert XML to a soup, after joining text lines into 1 long string
    # TODO compare time for joining by 'reduce()' with 'str.join()'
    time_start = time()
    print 'XML',
    ...
    # limit number of actual deletions to perform (e.g. for testing)
    if args.ndel:
        N = args.ndel
    else:
        N = len(duped_urls)
    ...
    # actual deletions
    # TODO: very resource consuming, try deleting from original XML
    ...
    # rechecking that all duplications were deleted
